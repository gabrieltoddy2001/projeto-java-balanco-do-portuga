...
public class ClienteForm extends JFrame {
    ...
    private final Font fontePadrao = new Font("Segoe UI", Font.PLAIN, 16);
...
private void adicionarCliente() {
    ...
    // TEXTFIELD FACTORY
    Function<Dimension, JTextField> campoTexto = (dim) -> {
    ...
    // CAMPOS
    JTextField nome = campoTexto.apply(new Dimension(260, 30));
    JTextField email = campoTexto.apply(new Dimension(260, 30));
    JTextField endereco = campoTexto.apply(new Dimension(260, 30));
    JTextField bairro = campoTexto.apply(new Dimension(260, 30));
    JTextField cidade = campoTexto.apply(new Dimension(160, 30));
    JTextField numero = campoTexto.apply(new Dimension(70, 30));
    JTextField estado = campoTexto.apply(new Dimension(50, 30));
    ...
    gbc.gridx = 0; gbc.weightx = 0; painelPrincipal.add(label.apply("Nome:"), gbc);
    gbc.gridx = 1; gbc.weightx = 1; painelPrincipal.add(nome, gbc);

    gbc.gridx = 2; gbc.weightx = 0; painelPrincipal.add(label.apply("CPF:"), gbc);
    gbc.gridx = 3; gbc.weightx = 0; painelPrincipal.add(cpf, gbc);

    // ---------------------- LINHA 2 ----------------------
    gbc.gridy = 1;

    gbc.gridx = 0; painelPrincipal.add(label.apply("E-mail:"), gbc);
    gbc.gridx = 1; gbc.weightx = 1; painelPrincipal.add(email, gbc);
    ...
    gbc.gridx = 1; gbc.weightx = 1; painelPrincipal.add(endereco, gbc);
    ...
    gbc.gridx = 1; gbc.weightx = 1; painelPrincipal.add(bairro, gbc);
    ...
    gbc.gridx = 1; gbc.weightx = 1; painelPrincipal.add(estado, gbc);
    ...
    btnSalvar.addActionListener(e -> {
        try {
            ...
            if (!com.balancodoportuga.util.ValidadorCliente.validar(
                    ...
                    c.getTelefone(), c.getEndereco(), c.getNumero(),
    ...
    btnSalvar.addActionListener(e -> {
        try {
            ...
            if (!com.balancodoportuga.util.ValidadorCliente.validar(
                    atualizado.getNome(), atualizado.getCpf(), atualizado.getEmail(),
                    atualizado.getTelefone(), atualizado.getEndereco(),
                    atualizado.getNumero(), atualizado.getBairro(),
                    atualizado.getCidade(), atualizado.getEstado()
            )) return;

            controller.atualizarCliente(atualizado);
            carregarClientes();
