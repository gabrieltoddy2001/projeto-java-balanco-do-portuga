...
public class ClienteService {
    ...
    // Retorna a reserva ativa (Solicitada ou Em andamento) do cliente */
    public Reserva buscarReservaAtiva(int clienteId) throws SQLException {
        ...
        for (Reserva r : reservas) {
            if (r.getStatus().equalsIgnoreCase("Em andamento") || r.getStatus().equalsIgnoreCase("Solicitada")) {
                return r;
            }
        }
        return null;
    ...
    //Registra um pagamento e atualiza o status da reserva automaticamente
